...
- [ ] Get attributes & categories list
- [ ] Get product stats
    - [ ] Total product count
    - [ ] Total active product count
    - [ ] Total inactive product count
    - [ ] Category count
    - [ ] Attribute count

## Others 
- [ ] Command for clear product data
    - [ ] Delete categories and attributes from database if they are not used by any product
