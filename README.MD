...
## Postman
For testing and generating documentation, you can also use the Postman collection available in [postman-collection.json](postman-collection.json) and [postman-environment.json](postman-environment.json).
